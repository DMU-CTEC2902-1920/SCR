...
namespace GameReviewWebsite.Controllers
{
    public class AnGamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GameId,Name,Description,Platform,ImgSrc,Price,DeveloperId,GenreID,ReviewId,ReviewReplyId")] AnGame anGame)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GameId,Name,Description,Platform,ImgSrc,Price,DeveloperId,GenreID,ReviewId,ReviewReplyId")] AnGame anGame)
        {
            if (ModelState.IsValid)
            {
