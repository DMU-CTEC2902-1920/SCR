...
namespace MVCGamesReviewWebsite.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] Developer developer)
        {
            if (ModelState.IsValid)
            {
