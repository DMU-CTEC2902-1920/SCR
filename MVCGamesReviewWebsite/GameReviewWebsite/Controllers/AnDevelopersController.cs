...
namespace GameReviewWebsite.Controllers
{
    public class AnDevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DeveloperId,Name,Description")] AnDeveloper anDeveloper)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DeveloperId,Name,Description")] AnDeveloper anDeveloper)
        {
            if (ModelState.IsValid)
            {
